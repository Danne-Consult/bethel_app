...
$pthImages					= 	'../images';				// name of the images directory
$Allowed_Extensions			= 	'png,jpg,jpeg,gif';		// allowed image extensions seperated by comma ex: png,jpg,jpeg,gif
$Max_File_Upload_Size		= 	4000; 					// Max upload file size in MBs
$PerPage  					= 	25;						// Number of images to display per page
