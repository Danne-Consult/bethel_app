...
<?php include 'components/allprofile.php' ?>
...
<?php include 'controllers/navigation/first-navigation.php'; ?>
	...
	<div class="container12 aboutproject">
		<article>
			...
			<div class="col-md-4">
					<div class="">
						<div class="profilepic" style="background:url(userfiles/avatars/<?php echo $rowluser['avatar']; ?>) no-repeat center; background-size:cover;"><div class="level"><p class="aligncenter"><span class="levelon"><?php echo $rowluser['levelon']; ?></span></p></div>
						</div>
					</div>
				</div>
				<div class="col-md-8" >
					<h3><?php echo $rowluser['username']; ?></h3>
					<p><b>About me:</b><br /><?php echo $rowluser['aboutme']; ?> <br /><br /><b>Organization:</b><br /><?php echo $rowluser['organization']; ?> </p>
				</div>
			</div>
		</article>
	</div>
